//
//  VisitPlanAddSelectGroupContactUserTableViewController.m
//  CMCCMarketing
//
...
#import "VisitPlanAddSelectGroupContactUserTableViewCell.h"


@interface VisitPlanAddSelectGroupContactUserTableViewController ()

@end

@implementation VisitPlanAddSelectGroupContactUserTableViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    self.selectUserDict=[self.tableArray objectAtIndex:indexPath.row];
