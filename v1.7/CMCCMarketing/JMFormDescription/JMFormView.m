...
- (UIToolbar *)toolBar
{
    ...
    UIBarButtonItem *previousBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"向前",@"")
    ...
    UIBarButtonItem *nextBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"向后",@"")
                                                                          style:UIBarButtonItemStyleBordered
                                                                         target:self
                                                                         action:@selector(nextTextField:)];
    [nextBarButtonItem setEnabled:[self.keyboardFormDelegate nextFormViewAvailableAfterFormView:self]];
    
    UIBarButtonItem *doneBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:NSLocalizedString(@"完成",@"")
